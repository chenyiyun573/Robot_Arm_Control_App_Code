package com.lobot.opensourcearm.widget;
...
import com.lobot.opensourcearm.R;
...
public class SearchDialog extends DialogFragment implements OnClickListener, OnItemClickListener {
    ...
    public void stopScan() {
        if (mBluetoothAdapter != null) {
            if (scanning) {
                mBluetoothAdapter.stopLeScan(leCallBack);titleTV.setText(R.string.dialog_search_finished);
